...
function register_tpbr_settings() {
  ...
  register_setting('tpbr-settings-group', 'tpbr_color', ['sanitize_callback' => 'sanitize_text_field']);
    ...
    <div class="tpbr_inner">
        ...
        <form method="post" action="options.php">
            ...
            <div class="tpbr_section_box">
                <h3 class="no-b-top"><?php echo __('General', 'top-bar'); ?>
                </h3>
                ...
                <div class="tpbr_settings_box">
                    <div class="tpbr_settings_item one-third startbit">
                        ...
                        <select name="tpbr_status">
                            ...
                            <option value="active" selected><?php echo __('Active', 'top-bar'); ?>
                            </option>
                            <option value="inactive"><?php echo __('Inactive', 'top-bar'); ?>
                            </option>
                            <?php } elseif ('inactive' == $current_status) { ?>
                            <option value="inactive" selected><?php echo __('Inactive', 'top-bar'); ?>
                            </option>
                            <option value="active"><?php echo __('Active', 'top-bar'); ?>
                            </option>
                            <?php } else { ?>
                            <option value="active" selected><?php echo __('Active', 'top-bar'); ?>
                            </option>
                    ...
                    <div class="tpbr_settings_item one-third">
                        ...
                        <select class="tpbr_fixed" name="tpbr_fixed">
                            ...
                            <option value="notfixed"><?php echo __('Standard', 'top-bar'); ?>
                            </option>
                            <option value="fixed" selected><?php echo __('Fixed', 'top-bar'); ?>
                            </option>
                            <?php } else { ?>
                            <option value="notfixed" selected><?php echo __('Standard', 'top-bar'); ?>
                            </option>
                            <option value="fixed"><?php echo __('Fixed', 'top-bar'); ?>
                            </option>
                            <?php } ?>
                        </select>
                    ...
                    <div class="tpbr_settings_item one-third endbit">
                        ...
                        <select class="tpbr_detect_sticky" name="tpbr_detect_sticky">
                            ...
                            <option value="1"><?php echo __('Enabled', 'top-bar'); ?>
                            </option>
                            <option value="0" selected><?php echo __('Disabled', 'top-bar'); ?>
                            </option>
                            <?php } elseif ('1' == $current_detect_sticky) { ?>
                            <option value="1" selected><?php echo __('Enabled', 'top-bar'); ?>
                            </option>
                            <option value="0"><?php echo __('Disabled', 'top-bar'); ?>
                            </option>
                            <?php } else { ?>
                            <option value="0" selected><?php echo __('Disabled', 'top-bar'); ?>
                            </option>
                ...
                <div class="tpbr_settings_box">
                    ...
                    <div class="tpbr_settings_item one-third endbit">
                        ...
                        <select class="tpbr_yn_button" name="tpbr_yn_button">
                            ...
                            <option value="button" selected><?php echo __('Enabled', 'top-bar'); ?>
                            </option>
                            <option value="nobutton"><?php echo __('Disabled', 'top-bar'); ?>
                            </option>
                            <?php } elseif ('nobutton' == $current_status) { ?>
                            <option value="nobutton" selected><?php echo __('Disabled', 'top-bar'); ?>
                            </option>
                            <option value="button"><?php echo __('Enabled', 'top-bar'); ?>
                            </option>
                            <?php } else { ?>
                            <option value="nobutton" selected><?php echo __('Disabled', 'top-bar'); ?>
                            </option>
                    ...
                    <div class='tpbr_button_box'>
                        ...
                        <div class="tpbr_settings_item one-third endbit">
                            ...
                            <select class="tpbr_btn_behavior" name="tpbr_btn_behavior">
                                ...
                                <option value="newwindow" selected><?php echo __('New window', 'top-bar'); ?>
                                </option>
                                <option value="samewindow"><?php echo __('Same window', 'top-bar'); ?>
                                </option>
                                <?php } else { ?>
                                <option value="samewindow" selected><?php echo __('Same window', 'top-bar'); ?>
                                </option>
                                <option value="newwindow"><?php echo __('New window', 'top-bar'); ?>
                                </option>
                                <?php } ?>
                            </select>
                ...
                <div class="tpbr_settings_box">
                    ...
                    <div class="tpbr_settings_item one-third startbit">
                        ...
                        <select class="tpbr_guests_or_users" name="tpbr_guests_or_users">
                            ...
                            <option value="all" selected><?php echo __('Everyone', 'top-bar'); ?>
                            </option>
                            <option value="guests"><?php echo __('Guests', 'top-bar'); ?>
                            </option>
                            <option value="users"><?php echo __('Registered users', 'top-bar'); ?>
                            </option>
                            <?php } elseif ('guests' == $current_status) { ?>
                            <option value="all"><?php echo __('Everyone', 'top-bar'); ?>
                            </option>
                            <option value="guests" selected><?php echo __('Guests', 'top-bar'); ?>
                            </option>
                            <option value="users"><?php echo __('Registered users', 'top-bar'); ?>
                            </option>
                            ...
                            <option value="users" selected><?php echo __('Registered users', 'top-bar'); ?>
                            </option>
                            <?php } else { ?>
                            <option value="all" selected><?php echo __('Everyone', 'top-bar'); ?>
                            </option>
                    ...
                    <div class="tpbr_settings_item two-third endbit">
                        ...
                        <h4 style="margin-bottom:5px;"><?php echo __('Color', 'top-bar'); ?>
                        </h4>
