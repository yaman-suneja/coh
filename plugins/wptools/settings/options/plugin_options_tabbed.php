...
*/
			...
			*/
			$fields[] = array(
				...
				'label' =>esc_attr__("Enable Auto Update Plugin?", "wptools"),
				'radio_options' => array(
					array('value' => 'Yes', 'label' =>esc_attr__('Yes, enable only WP Tools', "wptools")),
...
try{
	...
	echo '<hr>';
	echo '<br />';
	echo '(*) '.esc_attr__('You can use our free plugin','wptools').' ';
	echo '<a href="https://wordpress.org/plugins/wp-memory/">wp-memory</a>';
	echo '&nbsp;';
	esc_attr_e('to increase and fix it if necessary.','wptools').' ';	
	echo '&nbsp;';
