...
if ( ! class_exists( 'User_Signup_On_Hold' ) ) :

	/**
	 *  Class User_Signup_On_Hold
	 */
	class User_Signup_On_Hold extends WC_Email {

		/**
		 * Constructor.
		 */
		public function __construct() {
			$this->id            = 'on_hold_user';
			$this->title         = __( 'User Sign Up On Hold', 'b2b-ecommerce' );
			$this->description   = __( 'User on hold emails are sent to chosen recipient(s) when user have been on hold by admin.', 'b2b-ecommerce' );
			$this->template_html = 'emails/customer-signup-on-hold.php';
		...
		public function get_default_subject() {
			return __( '[{site_title}]: User Request For {email} Has Been kept on hold', 'b2b-ecommerce' );
		}
		...
		public function get_default_heading() {
			return __( 'User Request On Hold ', 'b2b-ecommerce' );
		}
