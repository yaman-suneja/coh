...
if ( ! class_exists( 'User_Signup_Rejected', false ) ) :

	/**
	 *  Class User_Signup_Rejected
	 */
	class User_Signup_Rejected extends WC_Email {

		/**
		 * Constructor.
		 */
		public function __construct() {
			$this->id            = 'rejected_user';
			$this->title         = __( 'User Sign Up Rejected', 'b2b-ecommerce' );
			$this->description   = __( 'User rejected emails are sent to chosen recipient(s) when user have been rejected by admin.', 'b2b-ecommerce' );
			$this->template_html = 'emails/customer-signup-rejected.php';
		...
		public function get_default_subject() {
			return __( '[{site_title}]: User Request For {email} Has Been Rejected', 'b2b-ecommerce' );
		}
		...
		public function get_default_heading() {
			return __( 'User Request Rejected ', 'b2b-ecommerce' );
		}
