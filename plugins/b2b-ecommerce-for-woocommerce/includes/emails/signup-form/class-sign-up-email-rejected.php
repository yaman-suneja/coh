...
if ( ! class_exists( 'User_Signup_Rejected', false ) ) :
	...
	class User_Signup_Rejected extends WC_Email {
		...
		public function __construct() {
			...
			$this->title         = __( 'User Sign Up Rejected', 'codup-wcrfq' );
			$this->description   = __( 'User rejected emails are sent to chosen recipient(s) when user have been rejected by admin.', 'codup-wcrfq' );
		...
		public function get_default_subject() {
			return __( '[{site_title}]: {email} User Request Has Been Rejected', 'codup-wcrfq' );
		}
		...
		public function get_default_heading() {
			return __( 'User Request Rejected: #{email}', 'codup-wcrfq' );
		}
