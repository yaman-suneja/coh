...
if ( ! class_exists( 'User_Signup_Accepted', false ) ) :
	...
	class User_Signup_Accepted extends WC_Email {
		...
		public function __construct() {
			...
			$this->title         = __( 'User Sign Up Accepted', 'codup-wcrfq' );
			$this->description   = __( 'User accepted emails are sent to chosen recipient(s) when user have been accepted by admin.', 'codup-wcrfq' );
		...
		public function get_default_subject() {
			return __( '[{site_title}]: User Request Has Been Accepted', 'codup-wcrfq' );
		}
		...
		public function get_default_heading() {
			return __( 'User Request Accepted', 'codup-wcrfq' );
		}
