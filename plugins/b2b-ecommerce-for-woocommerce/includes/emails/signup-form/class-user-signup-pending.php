...
if ( ! class_exists( 'User_Signup_Pending', false ) ) :
	...
	class User_Signup_Pending extends WC_Email {
		...
		public function __construct() {
			...
			$this->title         = __( 'User Sign Up Pending', 'b2b-ecommerce' );
			$this->description   = __( 'User pending emails are sent to chosen recipient(s) when user apply for signup.', 'b2b-ecommerce' );
		...
		public function get_default_subject() {
			return __( '[{site_title}]: User Request Is Pending', 'b2b-ecommerce' );
		}
		...
		public function get_default_heading() {
			return __( 'User Request Pending', 'b2b-ecommerce' );
		}
