...
if ( ! class_exists( 'User_Signup_Email_To_Admin', false ) ) :

	/**
	 *  Class User_Signup_Email_To_Admin
	 */
	class User_Signup_Email_To_Admin extends WC_Email {

		/**
		 * Constructor.
		 */
		public function __construct() {
			$this->id            = 'new_b2b_user_register';
			$this->title         = __( 'User Sign Up Email To Admin', 'b2b-ecommerce' );
			$this->description   = __( 'User Sign Up emails are sent to admin when a user registered from signup form.', 'b2b-ecommerce' );
			$this->template_html = 'emails/new-user-mail-to-admin.php';
		...
		public function get_default_subject() {
			return __( '[{site_title}]: New User Registered', 'b2b-ecommerce' );
		}
		...
		public function get_default_heading() {
			return __( 'New User Registered', 'b2b-ecommerce' );
		}
