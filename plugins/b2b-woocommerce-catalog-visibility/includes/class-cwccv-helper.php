...
class CWCCV_Helper {
	 ...
	 */
	public static function get_select( $name, $args, $select_id = '' ) {
		if ( ! isset( $name ) ) {
			return;
		}
		$dropdown = '<select name="' . $name . '" id="' . $select_id . '" class="' . CWCCV_PLUGIN_PREFIX . '_selectpicker ' . ( isset( $args['class'] ) ? $args['class'] : '' ) . '" multiple ' . ( isset( $args['is_disabled'] ) ? $args['is_disabled'] : '' ) . ' ' . ( isset( $args['is_required'] ) ? '' : '' ) . ' >';
	...
	public static function get_repeater_fields_button( $args ) {
		...
		$repeater_fields_button = '<button type="button" name="' . $args['name'] . '" class="cwccv_repeater_field_button ' . ( isset( $args['class'] ) ? $args['class'] : '' ) . '">+</button>';
		$allowed_html           = array(
			'button' => array(
				'name'  => array(),
				'class' => array(),
	...
	public static function get_priority_select( $args ) {
		...
		$priority_select = '<select id="' . ( isset( $args['id'] ) ? $args['id'] : '' ) . '" name="' . $args['name'] . '" class="' . ( isset( $args['class'] ) ? $args['class'] : '' ) . ' ' . CWCCV_PLUGIN_PREFIX . '_priority_select" title="' . ( isset( $args['title'] ) ? $args['title'] : '' ) . '" >';
	...
	public static function get_user_groups() {
		...
		if ( $groups ) {
			foreach ( $groups as $key => $group ) {
				$user_groups[ $key ]['id']   = $group;
				$user_groups[ $key ]['name'] = $group;
			}
		}
		return $user_groups;
	}
