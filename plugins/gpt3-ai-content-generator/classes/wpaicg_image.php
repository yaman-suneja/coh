                    ...
                    if($wpaicg_pricing_handling['limited']){
                        ...
                        if (isset($img_result->error)) {
                            ...
                            if(strpos($wpaicg_result['msg'],'limit has been reached') !== false){
                                $wpaicg_result['msg'] .= ' Please note that this message is coming from OpenAI and it is not related to our plugin. It means that you do not have enough credit from OpenAI. You can check your usage here: https://platform.openai.com/account/usage';
                            }
                        } else {
