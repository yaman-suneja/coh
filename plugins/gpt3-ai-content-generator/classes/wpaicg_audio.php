    ...
    class WPAICG_Audio
    {
        ...
        public function wpaicg_audio_converter()
        {
            ...
            if(empty($text_generated)){
                $wpaicg_result['msg'] = 'The model predicted a completion that begins with a stop sequence, resulting in no output. Consider adjusting your prompt or stop sequences.';
                wp_send_json($wpaicg_result);
            }
