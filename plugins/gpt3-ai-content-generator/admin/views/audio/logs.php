        ...
        foreach ($wpaicg_audios->posts as $wpaicg_audio){
            ...
            <tr>
                ...
                <td>
                    ...
                    if($wpaicg_response != 'post' && $wpaicg_response != 'page'):
                    ?>
                        <a download href="<?php echo wp_nonce_url(site_url('index.php?wpaicg_download_audio='.$wpaicg_audio->ID),'wpaicg_download_'.$wpaicg_audio->ID)?>" class="button button-primary button-small">Download</a>
                    <?php
                    endif;
                    ?>
                    <a onclick="return confirm('Are you sure?')" href="<?php echo wp_nonce_url(admin_url('admin.php?page=wpaicg_audio&action=logs&audio_delete='.$wpaicg_audio->ID),'wpaicg_delete_'.$wpaicg_audio->ID)?>" class="button button-link-delete button-small">Delete</a>
                </td>
            </tr>
            <?php
        }
