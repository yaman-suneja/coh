...
<form id="wpaicg_form_data" action="" method="post">
    ...
    <div class="wpaicg_list_data">
        <div class="wpaicg_data_item">
            <div class="text-center"><strong>Prompt</strong></div>
            <div class="text-center"><strong>Completion</strong></div>
        </div>
        <div class="wpaicg_data_list">
            <div class="wpaicg_data_item wpaicg_data">
                <div>
                    <input type="text" name="data[0][prompt]" class="regular-text wpaicg_data_prompt" placeholder="Prompt">
                </div>
                <div>
                    <input type="text" name="data[0][completion]" class="regular-text wpaicg_data_completion" placeholder="Completion">
                    <span class="button button-link-delete">&times;</span>
                </div>
            </div>
        </div>
        <button class="button button-primary wpaicg_add_data" type="button">Add More</button>
    </div>
    ...
    <button class="button-primary button wpaicg_submit" style="width: 100%;">Upload</button>
</form>
