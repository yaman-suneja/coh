...
<div id="tabs-6">
    <div class="wpcgai_form_row">
        <label class="wpcgai_label">Meta Description:</label>
        ...
        <a class="wpcgai_help_link" href="https://gptaipower.com/generate-meta-description-for-your-posts-with-gpt/" target="_blank">?</a>
    </div>
    <div class="wpcgai_form_row">
        <label class="wpcgai_label">Include in HTML:</label>
    ...
    if(is_plugin_active('wordpress-seo/wp-seo.php')){
        ?>
        <div class="wpcgai_form_row">
            <label class="wpcgai_label">Update Yoast Meta?:</label>
    ...
    if(is_plugin_active('all-in-one-seo-pack/all_in_one_seo_pack.php')){
        ?>
        <div class="wpcgai_form_row">
            <label class="wpcgai_label">Update All In One SEO Meta?:</label>
    ...
    if(is_plugin_active('seo-by-rank-math/rank-math.php')){
        ?>
        <div class="wpcgai_form_row">
            <label class="wpcgai_label">Update Rank Math Meta?:</label>
