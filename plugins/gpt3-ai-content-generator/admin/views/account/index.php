...
if($wpaicg_form_tokens['limit']){
    if($wpaicg_form_tokens['limited']){
        $wpaicg_tokens_forms_left = __('Out of Quota','gpt3-ai-content-generator');
...
if($wpaicg_promptbase_tokens['limit']){
    if($wpaicg_promptbase_tokens['limited']){
        ...
        $wpaicg_tokens_promptbase_left = __('Out of Quota','gpt3-ai-content-generator');
    }
    else{
...
if($wpaicg_image_tokens['limit']){
    if($wpaicg_image_tokens['limited']){
        ...
        $wpaicg_tokens_image_left = __('Out of Quota','gpt3-ai-content-generator');
    }
    else{
...
if($wpaicg_chat_has_limit){
    ...
    if($wpaicg_token_usage_client > $wpaicg_chat_total_token){
        ...
        $wpaicg_tokens_chat_left = __('Out of Quota','gpt3-ai-content-generator');
    }
    else{
...
<div class="wpaicg_account_page">
    <div class="wpaicg_account_header">
        ...
        <div class="wpaicg_account_header_item">
            ...
            <strong class="<?php echo $wpaicg_image_limited ? 'wpaicg_limited':''?>"><?php echo $wpaicg_tokens_image_left != __('Unlimited','gpt3-ai-content-generator') && $wpaicg_tokens_image_left !== __('Out of Quota','gpt3-ai-content-generator') ? '$':''?><?php echo esc_html($wpaicg_tokens_image_left)?></strong>
        </div>
    </div>
