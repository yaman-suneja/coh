        ...
        <div class="wobef-modal-box wobef-modal-box-sm">
            <div class="wobef-modal-content">
                <div class="wobef-modal-title">
                    <h2><?php esc_html_e('Order', 'ithemeland-woocommerce-bulk-orders-editing-lite'); ?> <span id="wobef-modal-order-shipping-item-title" class="wobef-modal-item-title"></span></h2>
                ...
                <div class="wobef-modal-body">
                    <div class="wobef-wrap">
                        <div class="wobef-col-full wobef-mb20">
                            ...
                            <a href="javascript:;" class="wobef-modal-load-shipping-address" data-target="#wobef-modal-order-shipping" data-order-field="customer-user-id" data-customer-id=""><?php esc_html_e('Load shipping address', 'ithemeland-woocommerce-bulk-orders-editing-lite'); ?></a>
                            <span> | </span>
                            <a href="javascript:;" href="javascript:;" class="wobef-modal-load-billing-address" data-target="#wobef-modal-order-shipping" data-order-field="customer-user-id" data-customer-id=""><?php esc_html_e('Copy billing address', 'ithemeland-woocommerce-bulk-orders-editing-lite'); ?></a>
                        </div>
                        ...
                        <div class="wobef-col-half">
                            ...
                            <div class="wobef-mb10">
                                <label for="wobef-modal-order-shipping-state"><?php esc_html_e('State', 'ithemeland-woocommerce-bulk-orders-editing-lite'); ?></label>
