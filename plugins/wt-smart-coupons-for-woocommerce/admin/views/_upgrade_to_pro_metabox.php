...
<style type="text/css">
    ...
    #wt-sc-upgrade-to-pro .wt-sc-metabox-pro-features li .new_flag{ display:inline-block; width:40px; height:21px; background:url(<?php echo esc_attr(WT_SMARTCOUPON_MAIN_URL);?>images/new_flag.svg) no-repeat; color:#fff; text-align:center; font-weight:normal; padding-left:4px; line-height:20px; font-size:12px; text-shadow:0px 2px 4px rgba(0, 0, 0, 0.35); margin-left:7px;}  
...
<ul class="wt-sc-metabox-pro-features">
    <li><span class="dashicons dashicons-yes-alt"></span><?php _e('Advanced BOGO Coupons', 'wt-smart-coupons-for-woocommerce');?> <span class="new_flag"><?php _e('New', 'wt-smart-coupons-for-woocommerce');?></span></li>
